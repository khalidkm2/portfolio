...
const Skills = () => {
  ...
  return (
    <div ref={ref} className={`transition-all ease-in duration-700 ${inView ? 'animate-slideInRight' : ''} border border-gray-600 bg-black text-gray-400 md:h-[150px] max-w-[1200px] mx-auto grid grid-cols-6 place-items-center md:flex md:justify-between md:items-center`}>
